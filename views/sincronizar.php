...
// Solo admin o médico autorizado
requirePermission('configurar_sistema'); // Verificar permiso para configurar sistema
...
<head>
    ...
    <title>Sincronización - Sistema Médico</title>
                ...
                <div class="card sync-card fade-in">
                    ...
                    <div class="sync-status">
                        <?php if ($pendingCount > 0): ?>
                            <span class="status-pending">⚠️</span>
                        <?php else: ?>
                    ...
                    <p class="text-muted mt-2" style="font-size: 0.9rem;">
                        Los datos se respaldarán en Supabase.
                    </p>
                </div>
                
                <!-- Debug / Logs View -->
                 <div class="card">
                    <h3>🔍 Cola de Sincronización (Últimos 10)</h3>
                    <?php
